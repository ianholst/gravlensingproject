...
The NFW profile has had some success in describing dark matter halos is both simulations and observations, though
\citep{Navarro1997}
\begin{equation}
...
%\begin{figure}
%    \centering
%    \includegraphics{nfwfitparams.pdf}
%    \label{}
%\end{figure}

%\begin{figure}
%    \centering
%    \includegraphics{isothermalfitparams.pdf}
%    \label{}
%\end{figure}
